...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Joel Anthony Arauz Masg", "https://www.gooogle.com",
			"Joel");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Joel", "Joel", "1.0",
